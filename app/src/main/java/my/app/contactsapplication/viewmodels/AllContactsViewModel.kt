...
import my.app.contactsapplication.ui.ContactsListFragment.AllContactView
...
class AllContactsViewModel  @Inject constructor(private val store : AllContactStore) : ViewModel() {
